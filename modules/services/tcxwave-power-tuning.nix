...
let
  cfg = config.jupiter.tcxWavePowerTuning;
in
{
  options.jupiter.tcxWavePowerTuning = {
    enable = lib.mkEnableOption "TCx Wave power/kernel tuning (TLP, zram, i915, initrd slimming)";
  };
