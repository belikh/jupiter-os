...
# TCx Wave kiosk: office. One of 4 identical 6140-E45 units (see
...
# can't share an identity.
{
  ...
  jupiter.storage = {
    profile = "impermanent";
    disk = "/dev/disk/by-id/REPLACE-ME-adrastea-os-disk";
  };
  ...
  jupiter.dashboardKiosk = {
    enable = true;
    url = "https://iot.jupiter.au/office-command/office";
  };
