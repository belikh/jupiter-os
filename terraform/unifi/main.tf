...
# The Default LAN (import this using: terraform import unifi_network.default <id>)
...
resource "unifi_firewall_rule" "allow_resolver_dns" {
...
resource "unifi_firewall_rule" "block_all_other_dns" {
