...
4. This data is stored locally in `~/.opencode/reflect/meta/`
...
View raw scores:
```bash
python ~/.opencode/skills/reflect/scripts/meta_learning.py scores
```

Reset all meta-learning data:
```bash
python ~/.opencode/skills/reflect/scripts/meta_learning.py reset --confirm
```
