...
**Context**: After the assistant proposes approach
**Action**: Add approach to Best Practices
**Rationale**: User validates the assistant's decision
...
3. Captures the assistant's previous approach (for comparisons)
