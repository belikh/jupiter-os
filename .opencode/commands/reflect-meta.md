...
4. This data is stored locally in `~/.opencode/skills/reflect/data/meta/`
...
View raw scores:
```bash
python3 "${SKILLS_ROOT:-.opencode/skills}/reflect/scripts/meta_learning.py" scores
```

Reset all meta-learning data:
```bash
python3 "${SKILLS_ROOT:-.opencode/skills}/reflect/scripts/meta_learning.py" reset --confirm
```
