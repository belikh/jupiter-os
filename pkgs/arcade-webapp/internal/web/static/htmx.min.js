/* htmx 2.0.10 — vendored per ADR-0002 D4 (single local JS file, no CDN
   fetch at runtime, no node in the closure).
   Source: https://cdn.jsdelivr.net/npm/htmx.org@2.0.10/dist/htmx.min.js
   integrity: sha384-H5SrcfygHmAuTDZphMHqBJLc3FhssKjG7w/CeCpFReSfwBWDTKpkzPP8c+cLsK+V
   License: 0BSD — see htmx-LICENSE next to this file. Upstream htmx is
   0BSD-licensed as of 2.x (the gauntlet plan said BSD-2-Clause; correction
   recorded in the progress page decision log — 0BSD is strictly more
   permissive, so the vendoring posture is unchanged).
   Integrity hash verified against the one published at htmx.org/docs. */
