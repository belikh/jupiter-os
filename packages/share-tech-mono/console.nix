...
stdenvNoCC.mkDerivation rec {
  ...
  buildPhase = ''
    ...
    # Force strict monospace metrics so bdf2psf accepts it
    sed -i "s/AVERAGE_WIDTH.*/AVERAGE_WIDTH 180/" ShareTechMono.bdf
    sed -i "s/SPACING \"P\"/SPACING \"C\"/" ShareTechMono.bdf

    # Convert BDF to PSF using bdf2psf translation tables
    # --fb flag is required for fonts wider than 9 pixels
    bdf2psf --fb ShareTechMono.bdf \
