...
#
# Consumed by BOTH:
#   * the NixOS resolver config (hosts/ganymede -> jupiter.dns), and
...
# IOT = VLAN 3 / 192.168.2.0/24.
{
  ...
  # cloudflared config on ganymede (hostname → local backend) and the public
  ...
  records = {
    ...
    "callisto.home.jupiter.au" = "10.1.1.21"; # diskless compute; syslog/Loki sink
