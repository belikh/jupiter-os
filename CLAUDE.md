...
| `europa` | `10.1.1.2` — ZFS NAS + data hub + PXE | ✅ live, **bdver4-tuned** (CI→Harmonia) | — |
...
**bdver4-tuned**, CI→Harmonia) → callisto
