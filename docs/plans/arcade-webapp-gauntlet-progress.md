...
- **Phase:** 1-2 complete — **P1, P2, P3 won** (blind critics) · **P4 in review**
...
| P4 — Library browsing | **review** | 1 (2 VM bring-up failures, both root-caused: pagination + missing awk) | — | — | module `artDir` option + `/library`·`/partials/library`·`/art` smoke green; commit `7a39e86` |
